...
void test1(const AuthChallenge& a, const AuthChallenge& b, const AuthChallenge& c){
NewTest();
if (!(compare_3(a,b)<0) && !(compare_3(b,c)<0) && (compare_3(a,c)<0))
ConsistencyChecker();
}

void test2(const AuthChallenge& a, const AuthChallenge& b, const AuthChallenge& c){
NewTest();
if ((compare_3(a,b)<0) && (compare_3(b,c)<0) && (compare_3(c,a)<0)) 
TransiveChecker();
}

void test3_1(const AuthChallenge& a, const AuthChallenge& b){
NewTest();
if ((compare_3(a,b)>0)&&(compare_3(b,a)>0))
SymmetryChecker();
}

void test3_2(const AuthChallenge& a, const AuthChallenge& b){
NewTest();
if ((compare_3(a,b)<0)&&(compare_3(b,a)<0))
SymmetryChecker();
}

void test4(const AuthChallenge& a){
NewTest();
